...
<style scoped>
.product-card { cursor: pointer; height: 100%; display: flex; flex-direction: column; }
...
.card-info { padding: 1rem 1rem 1.25rem; background: var(--card); border-radius: 0 0 var(--radius-lg) var(--radius-lg); flex: 1; display: flex; flex-direction: column; gap: 0.375rem; }
